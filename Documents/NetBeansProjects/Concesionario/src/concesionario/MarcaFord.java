 ...
 * @author Usuario
 */
public class MarcaFord extends Concesionario {

    //heredamos de la classe principal "Concesionario"
    public MarcaFord(String nomcliente, String apellido, int cedulacliente, String direccion, String numTelef, double tipoauto, double tiposeguro) {
