 ...
 * @author Usuario
 */
public class MarcaToyota extends Concesionario {

    //heredamos de la classe principal "Concesionario"
    public MarcaToyota(String nomcliente, String apellido, int cedulacliente, String direccion, String numTelef, double tipoauto, double tiposeguro) {
