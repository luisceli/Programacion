 ...
 * @author Usuario
 */
public class MarcaMazda extends Concesionario {
//heredamos de la classe principal "Concesionario"
    public MarcaMazda(String nomcliente, String apellido, int cedulacliente, String direccion, String numTelef, double tipoauto, double tiposeguro) {
